  ...
  const handleSave = async () => {
    ...
    try {
      ...
      const response = await axios.put(
        `${getApiUrl()}/api/user/drivers/${driverId}`,
        formData,
        {
          headers: {
            Authorization: `Bearer ${token}`,
    ...
    <ScrollView style={styles.container}>
      ...
      <View style={styles.formContainer}>
        ...
        <View style={styles.inputGroup}>
          ...
          <TextInput
            style={[styles.input, errors.vehicleMake ? styles.inputError : null]}
        ...
        <View style={styles.inputGroup}>
          ...
          <TextInput
            style={[styles.input, errors.vehiclePlate ? styles.inputError : null]}
